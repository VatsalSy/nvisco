...
@partial(jit, static_argnums=(1,2,))
def uniaxial_cyclic(params, norm, useNODE, time_load, time_unload, lm1dot, tpeak, dt0): # Just like uniaxial_monotone, except this one does unloading in addition to loading.
    # loading
    yprime = lambda t, y, args: np.array(yprime_uniaxial(y,t,lm1dot,tpeak,params,norm,useNODE))
    term = ODETerm(yprime)
    solver = mysolver()
