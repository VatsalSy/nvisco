...
params, train_loss = train(loss, taui, dphidtaui, opt_state, key, nIter=50000)
with open('saved/phi_params_NI12.npy', 'wb') as f:
    pickle.dump(params, f)
with open('saved/phi_norm_w_NI12.npy', 'wb') as f:
    pickle.dump([inp_std, out_std], f)

fig,ax = plt.subplots()
ax.plot(train_loss)
ax.set_yscale('log')
fig.savefig('figs/train_Phi_NI12.jpg')
...
fig.savefig('figs/test_Phi_NI12.jpg')
